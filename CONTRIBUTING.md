...
The [Issues](https://github.com/niktekusho/logger-mock/issues) section collects questions, bug reports and feature requests.
...
3. and of course you can help fix issues either by demonstrating that the issue reported is not a problem anymore or by opening a Pull Request that changes some bit of something in `niktekusho/logger-mock` in a concrete and reviewable manner.

When opening a new issue in the `niktekusho/logger-mock` issue tracker, you should fill in a basic template (like the one below).
...
```sh
$ git clone https://github.com/<your_github_username>/logger-mock
$ cd logger-mock
```
...
```sh
$ git remote add upstream https://github.com/niktekusho/logger-mock
```
